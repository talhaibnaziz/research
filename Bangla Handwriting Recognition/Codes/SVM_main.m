    ...
    for loop=0:9
        for i=0:9
            for j=0:9
                ...
                svmdataset(thou*1000+loop*100+i*10+j+1,:) = SVM_LDP(img);
...
for i=1:1000:5001
    ...
    experiment_result(3, i:i+999, :) = multisvm(svmtrainset, trainres, svmtestset);
    %experiment_result(2, i:i+999, 1) = predict(gdpknn2, gdptestset2);
end

 for i=1:6000
     if(datares(i,1)==experiment_result(3, i, 1))
         correct = correct + 1;
     else
