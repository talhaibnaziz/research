...
int main()
{
    ...
    if(unweighted) fout.open("Results/k_vs_omega_u70_dbc.txt");
    else    fout.open("Results/k_vs_omega_w70_dbc.txt");
    ...
    //            cout<<"TESTCASE: "<<testcase<<endl;
                ...
                avg_degree=(double)(2*linkcnt)/(double)nodecnt;
