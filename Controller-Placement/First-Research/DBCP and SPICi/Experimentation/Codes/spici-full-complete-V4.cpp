...
// From v2. Cluster head selection function is changed. The head will be the minimum node from which the max of distances to all node in that cluster is minimum.
#include<bits/stdc++.h>
using namespace std;
